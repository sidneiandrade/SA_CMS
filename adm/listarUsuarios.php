...
<div class="adminx-content">
    ...
    <div class="adminx-main-content">
        <div class="container-fluid">
                        ...
                        <tbody>
                            <?php foreach ($listUsuario as $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="usuario?id=<?php echo $value['usu_id'] ?>" class="btn btn-pill btn-sm btn-outline-primary">Editar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="usuario" class="btn btn-pill btn-primary">Adicionar Usuário</a>
                </div>
            </div>
        </div>
    </div>
