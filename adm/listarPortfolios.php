...
<div class="adminx-content">
    ...
    <div class="adminx-main-content">
        <div class="container-fluid">
                        ...
                        <tbody>
                            <?php foreach ($listPortfolio as $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="portfolio?id=<?php echo $value['port_id'] ?>" class="btn btn-pill btn-sm btn-outline-primary">Editar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="portfolio" class="btn btn-pill btn-primary">Adicionar Portfólio</a>
                </div>
            </div>
        </div>
    </div>
