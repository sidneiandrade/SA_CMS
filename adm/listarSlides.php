...
<div class="adminx-content">
    ...
    <div class="adminx-main-content">
        <div class="container-fluid">
                        ...
                        <tbody>
                            <?php foreach ($list as $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="slide?id=<?php echo $value['sd_id'] ?>" class="btn btn-pill btn-sm btn-outline-primary">Editar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="slide" class="btn btn-pill btn-primary">Adicionar Slide</a>
                </div>
            </div>
        </div>
    </div>
