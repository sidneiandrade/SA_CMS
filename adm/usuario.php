                ...
                <div class="col-lg-6">
                    <div class="card mb-grid">
                        ...
                        <div class="card-body collapse show" id="cardCadastrar">
                            <form id="atualizarUsuario" action="./system/_usuario.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
...
<script>
    ...
    $("#atualizarUsuario").submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            url: "./system/_usuario.php",
            data: new FormData($('#atualizarUsuario')[0]),
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                if (data.acao == 'salvo') {
                    ...
                    setTimeout(function() {
                        location.href = "./usuario?id=" + (data.id)
                    }, 2500);
