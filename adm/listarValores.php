...
$list = $pdo->query("SELECT * FROM VALORES")->fetchAll(PDO::FETCH_ASSOC);
...
<div class="adminx-content">
    ...
    <div class="adminx-main-content">
        <div class="container-fluid">
                        ...
                        <tbody>
                            <?php foreach ($list as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="valor?id=<?php echo $value['val_id'] ?>" class="btn btn-pill btn-sm btn-outline-primary">Editar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <a href="valor" class="btn btn-pill btn-primary">Adicionar Valor</a>
                </div>
            </div>
        </div>
    </div>
